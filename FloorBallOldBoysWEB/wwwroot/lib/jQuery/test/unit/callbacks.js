...
(function() {
	...
	jQuery.each(tests,
		function(strFlags, resultString) {
				...
				function(filterLabel) {
					...
					jQuery.each({
						...
						function(flagsTypes, flags) {
							...
							QUnit.test("jQuery.Callbacks( " + showFlags(flags) + " ) - " + filterLabel,
								function(assert) {
...
QUnit.test("jQuery.Callbacks( options ) - options are copied",
	function(assert) {
...
QUnit.test("jQuery.Callbacks.fireWith - arguments are copied",
	function(assert) {
...
QUnit.test("jQuery.Callbacks.remove - should remove all instances",
	function(assert) {
...
QUnit.test("jQuery.Callbacks.has",
	function(assert) {
		...
		assert.strictEqual(cb.has(getA),
			true,
...
QUnit.test("jQuery.Callbacks() - adding a string doesn't cause a stack overflow",
	function(assert) {
...
QUnit.test("jQuery.Callbacks() - disabled callback doesn't fire (gh-1790)",
	function(assert) {
...
QUnit.test("jQuery.Callbacks() - list with memory stays locked (gh-3469)",
	function(assert) {
