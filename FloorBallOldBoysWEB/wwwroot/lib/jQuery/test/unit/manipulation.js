...
QUnit.test("text(undefined)",
	function(assert) {

		assert.expect(1);

		assert.equal(jQuery("#foo").text("<div").text(undefined)[0].innerHTML,
			"&lt;div",
...
QUnit.test("text(Function) with incoming value",
	function(assert) {
...
function testAppend(valueObj, assert) {
	...
	assert.equal(jQuery("#select3").append(valueObj("<option value='appendTest'>Append Test</option>"))
	...
	$map = jQuery("<map/>")
		.append(valueObj("<area id='map01' shape='rect' coords='50,50,150,150' href='http://www.jquery.com/' alt='jQuery'>"));
	...
	assert.equal(jQuery("#select1 optgroup").attr("label"),
		"optgroup",
	...
	jQuery.each("thead tbody tfoot colgroup caption tr th td".split(" "),
		function(i, name) {
	...
	assert.equal(jQuery("<div/>").append("1", "", 3).text(),
		"13",
	...
	assert.equal(jQuery("<div/>").append(valueObj("option<area/>"))[0].childNodes.length,
		2,
		"HTML-string with leading text should be processed correctly");
}

QUnit.test("append(String|Element|Array<Element>|jQuery)",
	function(assert) {
...
QUnit.test("append(param) to object, see #11280",
	function(assert) {
...
QUnit.test("append(Function) returns String",
	function(assert) {
...
QUnit.test("append(Function) returns Element",
	function(assert) {
...
QUnit.test("append(Function) returns Array<Element>",
	function(assert) {
...
QUnit.test("append(Function) returns jQuery",
	function(assert) {
...
QUnit.test("append(Function) returns Number",
	function(assert) {
...
QUnit.test("XML DOM manipulation (#9960)",
	function(assert) {
...
QUnit.test("append HTML5 sectioning elements (Bug #6485)",
	function(assert) {
		...
		jQuery("#qunit-fixture")
			.append("<article style='font-size:10px'><section><aside>HTML5 elements</aside></section></article>");
...
if (jQuery.css) {
	QUnit.test("HTML5 Elements inherit styles from style rules (Bug #10501)",
		function(assert) {
...
QUnit.test("html(String) with HTML5 (Bug #6485)",
	function(assert) {

		assert.expect(2);

		jQuery("#qunit-fixture").html("<article><section><aside>HTML5 elements</aside></section></article>");
		assert.equal(jQuery("#qunit-fixture").children().children().length,
			1,
			"Make sure HTML5 article elements can hold children. innerHTML shortcut path");
		assert.equal(jQuery("#qunit-fixture").children().children().children().length,
			1,
			"Make sure nested HTML5 elements can hold children.");
	});

QUnit.test("html(String) tag-hyphenated elements (Bug #1987)",
	function(assert) {
...
QUnit.test("Tag name processing respects the HTML Standard (gh-2005)",
	function(assert) {
		...
		function assertSpecialCharsSupport(method, characters) {
			...
			assert.equal(child.nodeName.toUpperCase(),
...
QUnit.test("IE8 serialization bug",
	function(assert) {
...
QUnit.test("html() object element #10324",
	function(assert) {
...
QUnit.test("appendTo(String)",
	function(assert) {
		...
		assert.equal(jQuery("<option value='appendTest'>Append Test</option>").appendTo("#select3").parent()
			.find("option:last-child").attr("value"),
			"appendTest",
			"Appending html options to select element");
...
QUnit.test("appendTo(Element|Array<Element>)",
	function(assert) {
...
QUnit.test("appendTo(jQuery)",
	function(assert) {

		assert.expect(10);

		var expected, num, div;
		assert.ok(jQuery(document.createElement("script")).appendTo("body").length,
...
QUnit.test("prepend(String)",
	function(assert) {
		...
		assert.equal(jQuery("#select3").prepend("<option value='prependTest'>Prepend Test</option>")
			.find("option:first-child").attr("value"),
			"prependTest",
			"Prepending html options to select element");
	});

QUnit.test("prepend(Element)",
	function(assert) {
...
QUnit.test("prepend(Array<Element>)",
	function(assert) {
...
QUnit.test("prepend(Array<jQuery>)",
	function(assert) {
...
QUnit.test("prepend(Function) with incoming value -- String",
	function(assert) {
...
QUnit.test("prepend(Function) with incoming value -- Element",
	function(assert) {
...
QUnit.test("prepend(Function) with incoming value -- Array<Element>",
	function(assert) {
...
QUnit.test("prepend(Function) with incoming value -- jQuery",
	function(assert) {
...
QUnit.test("prependTo(String)",
	function(assert) {
		...
		assert.equal(jQuery("<option value='prependTest'>Prepend Test</option>").prependTo("#select3").parent()
			.find("option:first-child").attr("value"),
			"prependTest",
			"Prepending html options to select element");
...
QUnit.test("prependTo(Array<Element>)",
	function(assert) {
...
QUnit.test("prependTo(Array<jQuery>)",
	function(assert) {
...
QUnit.test("before(Array<Element>)",
	function(assert) {
...
QUnit.test("before(Array<jQuery>)",
	function(assert) {
...
QUnit.test("before(Function) -- Returns String",
	function(assert) {
...
QUnit.test("before(Function) -- Returns Element",
	function(assert) {
...
QUnit.test("before(Function) -- Returns Array<Element>",
	function(assert) {
		...
		expected = "This is a normal link: Try them out:diveintomarkYahoo";
		jQuery("#yahoo")
			.before(manipulationFunctionReturningObj([document.getElementById("first"), document.getElementById("mark")]));
		assert.equal(jQuery("#en").text(), expected, "Insert array of elements before");
	});

QUnit.test("before(Function) -- Returns jQuery",
	function(assert) {
...
QUnit.test("before(Function) -- Returns Array<jQuery>",
	function(assert) {
...
QUnit.test("before and after w/ empty object (#10812)",
	function(assert) {
...
QUnit.test(".before() and .after() disconnected node",
	function(assert) {
...
QUnit.test("insert with .before() on disconnected node last",
	function(assert) {
...
QUnit.test("insert with .before() on disconnected node first",
	function(assert) {
...
QUnit.test("insertBefore(String)",
	function(assert) {
...
QUnit.test("insertBefore(Element)",
	function(assert) {
...
QUnit.test("insertBefore(Array<Element>)",
	function(assert) {
...
QUnit.test("insertBefore(jQuery)",
	function(assert) {
...
QUnit.test(".after(Array<Element>)",
	function(assert) {
...
QUnit.test(".after(Function) returns String",
	function(assert) {
...
QUnit.test(".after(Function) returns Element",
	function(assert) {
...
QUnit.test(".after(Function) returns Array<Element>",
	function(assert) {
...
QUnit.test(".after(Function) returns jQuery",
	function(assert) {
...
QUnit.test(".after(disconnected node)",
	function(assert) {
...
QUnit.test("insertAfter(Element)",
	function(assert) {
...
QUnit.test("insertAfter(Array<Element>)",
	function(assert) {
...
function testReplaceWith(val, assert) {
	...
	tmp = jQuery("<div/>").appendTo("#qunit-fixture").on("click",
		function() {
			assert.ok(true, "Newly bound click run.");
		});
	y = jQuery("<div/>").appendTo("#qunit-fixture").on("click",
		function() {
			assert.ok(false, "Previously bound click run.");
		});
	child = y.append("<b>test</b>").find("b").on("click",
		function() {
	...
	child2 = y.append("<u>test</u>").find("u").on("click",
		function() {
	...
	assert.deepEqual(jQuery("#qunit-fixture").children().first().get(),
		child.get(),
	...
	assert.equal(jQuery("#qunit-fixture").find("div[id=replaceWith]").length,
		1,
...
QUnit.test("replaceWith(String|Element|Array<Element>|jQuery)",
	function(assert) {
...
QUnit.test("replaceWith(string) for more than one element",
	function(assert) {
...
QUnit.test("Empty replaceWith (trac-13401; trac-13596; gh-2204)",
	function(assert) {
		...
		jQuery.each(tests,
			function(label, input) {
				...
				assert.strictEqual($el.eq(0).html(),
					expectedHTML,
...
QUnit.test("replaceAll(Array<Element>)",
	function(assert) {
...
QUnit.test("jQuery.clone() (#8017)",
	function(assert) {
		...
		assert.equal(main.childNodes.length,
			clone.childNodes.length,
			"Simple child length to ensure a large dom tree copies correctly");
	});

QUnit.test("append to multiple elements (#8070)",
	function(assert) {

		assert.expect(2);

		var selects = jQuery("<select class='test8070'></select><select class='test8070'></select>")
			.appendTo("#qunit-fixture");
...
QUnit.test("clone()",
	function(assert) {
		...
		assert.equal(jQuery("<input type='checkbox'/>").clone()[0].nodeName.toLowerCase(),
			"input",
			"Clone a <input type='checkbox' />");

		// Check cloning non-elements
		assert.equal(jQuery("#nonnodes").contents().clone().length,
			3,
		...
		div = jQuery("<div><ul><li>test</li></ul></div>").on("click",
			function() {
		...
		div = jQuery("<div/>")
			.html("<embed height='355' width='425' src='http://www.youtube.com/v/3KANI2dpXLw&amp;hl=en'></embed>");
		...
		jQuery.each(["height", "width", "classid"],
			function(i, attr) {
...
QUnit.test("clone(script type=non-javascript) (#11359)",
	function(assert) {
		...
		assert.ok(
			/^\s*<scr.pt\s+type=['"]?text\/filler['"]?\s*>consectetur adipiscing elit<\/scr.pt>\s*$/i.test(dest.last().html()),
			"Cloning preserves nested script text");
		dest.remove();
	});

QUnit.test("clone(form element) (Bug #3879, #6655)",
	function(assert) {
		...
		assert.equal(element.clone().find("option").filter(function() { return this.selected; }).val(),
			"selected",
...
QUnit.test("clone(multiple selected options) (Bug #8129)",
	function(assert) {

		assert.expect(1);

		var element =
			jQuery("<select><option>Foo</option><option selected>Bar</option><option selected>Baz</option></select>");
...
QUnit.test("clone() on local XML nodes with html5 nodename",
	function(assert) {
...
QUnit.test("html(undefined)",
	function(assert) {

		assert.expect(1);

		assert.equal(jQuery("#foo").html("<i>test</i>").html(undefined).html().toLowerCase(),
			"<i>test</i>",
			".html(undefined) is chainable (#5571)");
	});

QUnit.test("html() on empty set",
	function(assert) {
...
function childNodeNames(node) {
	return jQuery.map(node.childNodes,
		function(child) {
...
function testHtml(valueObj, assert) {
	...
	jQuery("#qunit-fixture select")
		.html(valueObj("<option>O1</option><option selected='selected'>O2</option><option>O3</option>"));
	...
	fixture.html(valueObj(
		"foo <form><script type='text/javascript'>ok( true, 'Injection of identical script (#975)' );</script></form>"));
...
QUnit.test("html(Function) with incoming value -- direct selection",
	function(assert) {
...
QUnit.test("html(Function) with incoming value -- jQuery.contents()",
	function(assert) {
		...
		assert.equal(j.html().replace(/ xmlns="[^"]+"/g, "").toLowerCase(),
			"<b>bold</b>",
...
QUnit.test("clone()/html() don't expose jQuery/Sizzle expandos (#12858)",
	function(assert) {
...
QUnit.test("remove() with filters",
	function(assert) {
...
QUnit.test("remove() event cleaning ",
	function(assert) {
		assert.expect(1);
...
QUnit.test("remove() in document order #13779",
	function(assert) {
		assert.expect(1);
...
QUnit.test("detach() with filters",
	function(assert) {
...
QUnit.test("detach() event cleaning ",
	function(assert) {
		assert.expect(1);
...
QUnit.test("jQuery.cleanData",
	function(assert) {
		...
		function getDiv() {
			var div = jQuery("<div class='outer'><div class='inner'></div></div>").on("click",
				function() {
...
QUnit.test("jQuery.cleanData eliminates all private data (gh-2127)",
	function(assert) {
		assert.expect(3);
...
QUnit.test("jQuery.cleanData eliminates all public data",
	function(assert) {
		assert.expect(3);
...
QUnit.test("domManip plain-text caching (trac-6779)",
	function(assert) {
...
QUnit.test("domManip executes scripts containing html comments or CDATA (trac-9221)",
	function(assert) {
...
QUnit.test("jQuery.clone - no exceptions for object elements #9587",
	function(assert) {
...
QUnit.test("Cloned, detached HTML5 elems (#10667,10670)",
	function(assert) {
...
QUnit.test("Guard against exceptions when clearing safeChildNodes",
	function(assert) {
...
QUnit.test("Ensure oldIE creates a new set on appendTo (#8894)",
	function(assert) {

		assert.expect(5);

		assert.strictEqual(jQuery("<div/>").clone().addClass("test").appendTo("<div/>").end().end().hasClass("test"),
			false,
			"Check jQuery.fn.appendTo after jQuery.clone");
		assert.strictEqual(jQuery("<div/>").find("p").end().addClass("test").appendTo("<div/>").end().end().hasClass("test"),
			false,
			"Check jQuery.fn.appendTo after jQuery.fn.find");
		assert.strictEqual(jQuery("<div/>").text("test").addClass("test").appendTo("<div/>").end().end().hasClass("test"),
			false,
			"Check jQuery.fn.appendTo after jQuery.fn.text");
		assert.strictEqual(jQuery("<bdi/>").clone().addClass("test").appendTo("<div/>").end().end().hasClass("test"),
			false,
			"Check jQuery.fn.appendTo after clone html5 element");
		assert.strictEqual(jQuery("<p/>").appendTo("<div/>").end().length,
...
QUnit.asyncTest("html() - script exceptions bubble (#11743)",
	2,
	function(assert) {
...
QUnit.test("checked state is cloned with clone()",
	function(assert) {
...
QUnit.test("manipulate mixed jQuery and text (#12384, #12346)",
	function(assert) {
...
QUnit.test("script evaluation (#11795)",
	function(assert) {
...
QUnit.test("jQuery._evalUrl (#12838)",
	function(assert) {
...
QUnit.test("jQuery.htmlPrefilter (gh-1747)",
	function(assert) {
	...
	function(assert) {
		...
		jQuery.each([
			...
			function(index, name) {
				...
				assert.equal(jQuery("#test4087-complex li:last-child div").length,
					name === "replaceAll" ? 1 : 2,
...
QUnit.test("Index for function argument should be received (#13094)",
	function(assert) {
		assert.expect(2);
...
QUnit.test("Make sure jQuery.fn.remove can work on elements in documentFragment",
	function(assert) {
		assert.expect(1);
...
QUnit.test("Make sure specific elements with content created correctly (#13232)",
	function(assert) {
		assert.expect(20);
		...
		jQuery.each(elems,
			function(name, value) {
				...
				assert.ok(jQuery.parseHTML("<" + name + ">" + value + "</" + name + ">")[0].nodeName.toLowerCase() === name,
...
QUnit.test("Validate creation of multiple quantities of certain elements (#13818)",
	function(assert) {
		assert.expect(44);
...
QUnit.test("Make sure tr element will be appended to tbody element of table when present",
	function(assert) {
		assert.expect(1);
...
QUnit.test("Make sure tr elements will be appended to tbody element of table when present",
	function(assert) {
		assert.expect(1);
...
QUnit.test("Make sure tfoot element will not be appended to tbody element of table when present",
	function(assert) {
		assert.expect(1);
...
QUnit.test("Make sure document fragment will be appended to tbody element of table when present",
	function(assert) {
		assert.expect(1);
...
QUnit.test("Make sure col element is appended correctly",
	function(assert) {
		assert.expect(1);
...
QUnit.test("Make sure tr is not appended to the wrong tbody (gh-3439)",
	function(assert) {
		assert.expect(1);
...
QUnit.test("Insert script with data-URI (gh-1887)",
	1,
	function(assert) {
