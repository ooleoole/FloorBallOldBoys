...
// This module tests jQuery.Animation and the corresponding 1.8+ effects APIs
	...
	QUnit.test("Animation( subject, props, opts ) - shape",
		function(assert) {
			assert.expect(20);
	...
	QUnit.test("Animation.prefilter - prefilter return hooks",
		function(assert) {
			assert.expect(34);
	...
	QUnit.test("Animation.tweener( fn ) - unshifts a * tweener",
		function(assert) {
			assert.expect(2);
	...
	QUnit.test("Animation.tweener( 'prop', fn ) - unshifts a 'prop' tweener",
		function(assert) {
			assert.expect(4);
