...
// Can't test what ain't there
	...
	QUnit.test("jQuery.Tween - Default propHooks on plain objects",
		function(assert) {
			assert.expect(8);
	...
	QUnit.test("jQuery.Tween - Default propHooks on elements",
		function(assert) {
			assert.expect(19);
	...
	QUnit.test("jQuery.Tween - Plain Object",
		function(assert) {
			assert.expect(13);
	...
	QUnit.test("jQuery.Tween - Element",
		function(assert) {
			assert.expect(15);
	...
	QUnit.test("jQuery.Tween - No duration",
		function(assert) {
			assert.expect(3);
	...
	QUnit.test("jQuery.Tween - step function option",
		function(assert) {
			assert.expect(4);
	...
	QUnit.test("jQuery.Tween - custom propHooks",
		function(assert) {
			assert.expect(3);
	...
	QUnit.test("jQuery.Tween - custom propHooks - advanced values",
		function(assert) {
			assert.expect(5);
