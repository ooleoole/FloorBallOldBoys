...
jQuery.each(["", " - new operator"],
	function(_, withNew) {
		...
		QUnit.test("jQuery.Deferred" + withNew,
			function(assert) {
				...
				jQuery.expandedEach("resolve reject".split(" "),
					function(_, change) {
						createDeferred(function(defer) {
...
QUnit.test("jQuery.Deferred - chainability",
	function(assert) {
...
QUnit.test("jQuery.Deferred.then - filtering (done)",
	function(assert) {
...
QUnit.test("jQuery.Deferred.then - filtering (fail)",
	function(assert) {
...
QUnit.test("jQuery.Deferred.catch",
	function(assert) {
		assert.expect(4);
...
QUnit.test("[PIPE ONLY] jQuery.Deferred.pipe - filtering (fail)",
	function(assert) {
...
QUnit.test("jQuery.Deferred.then - filtering (progress)",
	function(assert) {
...
QUnit.test("jQuery.Deferred.then - deferred (done)",
	function(assert) {
...
QUnit.test("jQuery.Deferred.then - deferred (fail)",
	function(assert) {
...
QUnit.test("jQuery.Deferred.then - deferred (progress)",
	function(assert) {
...
QUnit.test("[PIPE ONLY] jQuery.Deferred.pipe - deferred (progress)",
	function(assert) {
...
QUnit.test("[PIPE ONLY] jQuery.Deferred.pipe - context",
	function(assert) {
...
QUnit.test("jQuery.Deferred.then - spec compatibility",
	function(assert) {
...
QUnit[window.console ? "test" : "skip"]("jQuery.Deferred.exceptionHook",
	function(assert) {
		...
		window.console.warn = function() {
			...
			if (/chrome/i.test(navigator.userAgent)) {
				oldChromium = parseInt(
						navigator.userAgent.match(/chrome\/(\d+)/i)[1],
						10) <
					42;
			}
			if (oldChromium) {
...
// Test fails in IE9 but is skipped there because console is not active
QUnit[window.console ? "test" : "skip"]("jQuery.Deferred.exceptionHook with stack hooks",
	function(assert) {
...
QUnit.test("jQuery.Deferred - 1.x/2.x compatibility",
	function(assert) {
		...
		jQuery.Deferred().notify(1, 2).then(null,
			null,
			function() {
				assert.deepEqual([].slice.call(arguments),
					[1, 2],
		...
		jQuery.Deferred().notifyWith(context).then(null,
			null,
			function() {
		...
		jQuery.Deferred().notify(thenable).then().then(null,
			null,
			function(value) {
...
QUnit.test("jQuery.Deferred.then - progress and thenables",
	function(assert) {
...
QUnit.test("jQuery.Deferred - notify and resolve",
	function(assert) {
...
QUnit.test("jQuery.Deferred - resolved to a notifying deferred",
	function(assert) {
...
QUnit.test("jQuery.when(nonThenable) - like Promise.resolve",
	function(assert) {
		"use strict";
...
QUnit.test("jQuery.when(thenable) - like Promise.resolve",
	function(assert) {
		"use strict";
...
QUnit.test("jQuery.when(a, b) - like Promise.all",
	function(assert) {
		"use strict";
...
QUnit.test("jQuery.when - always returns a new promise",
	function(assert) {
...
QUnit.test("jQuery.when - notify does not affect resolved",
	function(assert) {
...
QUnit.test("jQuery.when(...) - opportunistically synchronous",
	function(assert) {
