 ...
 */
	QUnit.diff = (function() {
		...
		DiffMatchPatch.prototype.diffHalfMatch = function(text1, text2) {
			...
			hm1 = diffHalfMatchI(longtext,
				shorttext,
				Math.ceil(longtext.length / 4));
			// Check again based on the third quarter.
			hm2 = diffHalfMatchI(longtext,
				shorttext,
						...
						if (countDelete !== 0 && countInsert !== 0) {
							...
							if (commonlength !== 0) {
								diffs[pointer][1] = textInsert.substring(textInsert.length -
										commonlength) +
									diffs[pointer][1];
								textInsert = textInsert.substring(0,
									textInsert.length -
									commonlength);
								textDelete = textDelete.substring(0,
									textDelete.length -
									commonlength);
							}
						}
...
// HTML Reporter initialization and load
	...
	QUnit.testStart(function(details) {
		...
		if (running) {
			...
			running.innerHTML = (bad ? "Rerunning previously failed test: <br />" : "Running: <br />") +
	...
	QUnit.testDone(function(details) {
		...
		testTitle.innerHTML += " <b class='counts'>(" +
			testCounts +
