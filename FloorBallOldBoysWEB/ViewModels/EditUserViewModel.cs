...
namespace FloorBallOldBoysWEB.ViewModels
{
    public class EditUserViewModel
    {
        ...
        [Required, MinLength(2, ErrorMessage = "Använd 2-35 tecken"), MaxLength(35, ErrorMessage = "Använd 2-35 tecken")]
        public string Street { get; set; }

        [Required, RegularExpression(@"^\d{3}\s{0,1}\d{2}\s{0,2}$", ErrorMessage = "Tillåtna format är 12345, 123 45")]
